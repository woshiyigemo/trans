<template>
    <div class="real_name">
        <div class="real_left">
            ...
            <router-link class="option" active-class="option-active" to="/account/security">账号安全</router-link>
            <router-link class="option" active-class="option-active" to="/account/identityverify">实名认证</router-link>
        </div>
